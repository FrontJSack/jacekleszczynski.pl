...
</p><ul class="list-disc list-inside"><li>JavaScript</li><li>TypeScript</li><li>Nuxt.js</li><li>Tailwind CSS</li><li>Astro.js</li><li>Three.js</li><li>Nest.js</li><li>Node.js</li></ul><p><a href="https://jacekleszczynski.pl/cv_jacek.pdf"><img src="https://skillicons.dev/icons?i=js,ts,tailwind,nuxt,astro,threejs,nestjs,node"></a></p><p class="text-xs font-light">
