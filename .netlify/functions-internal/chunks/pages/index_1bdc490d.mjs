...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/x-icon" href="/favicon.png"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta name="robots" content="/favicon/sitemap-index.xml"><!-- Basic OG tags for sharing your website's content on platforms like Facebook and cv --><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:type" content="website"><meta property="og:url" content="https://jacekleszczynski.pl"><meta property="og:image" content="https://jacekleszczynski.pl/me.png"><!-- Basic Twitter Card tags --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image" content="https://jacekleszczynski.pl/me.png"><link rel="preconnect" href="https://cdn.fontshare.com">${renderHead()}</head><body class="bg-darkslate-700 md:h-screen flex justify-center items-center"><div class="loaderRef bg-darkslate-700 text-neutral-50 text-3xl font-black uppercase flex justify-center items-center w-screen h-screen z-50 fixed top-0 bottom-0 right-0 left-0"></div>${renderSlot($$result, $$slots["default"])}</body></html>`;
...
</h1></header><address class="flex flex-col mt-4"><h2 class="text-gray-500">Contact Details</h2><p><a href="jacek@dgspectrum.com">jacek@dgspectrum.com</a></p></address><div class="flex flex-col mt-4 w-fit"><h2 class="text-gray-500">Socials</h2><ul><li><a${addAttribute(LINKS.cv, "href")} target="_blank">cv</a></li><li><a${addAttribute(LINKS.github, "href")} target="_blank">Github</a></li><li><a${addAttribute(LINKS.discord, "href")} target="_blank">Discord</a></li></ul></div></div>` })}`;
...
</p><ul class="list-disc list-inside"><li>JavaScript</li><li>TypeScript</li><li>Nuxt.js</li><li>Tailwind CSS</li><li>Astro.js</li><li>Three.js</li><li>Nest.js</li><li>Node.js</li></ul><p><a href="nuxt"><img src="https://skillicons.dev/icons?i=js,ts,tailwind,nuxt,astro,three,nestjs,node"></a></p><p class="text-sm font-light">
Beyond coding, I'm passionate about design and 3D modeling and traveling.
...
const $$Now = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Now;
  return renderTemplate`${renderComponent($$result, "Card", $$Index$1, { "colSpan": "md:col-span-1", "rowSpan": "md:row-span-1" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<div class="flex justify-between w-full items-start mb-2"><div class="flex flex-col"><h2>Now</h2><a href="https://sive.rs/nowff" target="_blank"><span class="text-xs text-gray-500 cursor-pointer">what's that ?</span></a></div>${renderComponent($$result2, "Pulse", $$Pulse, {})}</div><p class="text-xs">Currently working as freelancer</p>` })}`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Jacek Leszczy\u0144ski - Founder of DGSpectrum.com", "description": "Software developer with strong focus on the user experience animations and micro interactions, Owner of IT Software development company DGSpectrum.com" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<main class="text-white m-auto p-2 grid gap-2 max-w-6xl overflow-hidden relative w-full sm:p-4 sm:gap-2 md:grid-cols-2 md:gap-3 md:p-6 lg:h-screen lg:grid-cols-4 lg:gap-4 lg:max-h-[800px]">${renderComponent($$result2, "IntroCard", $$IntroCard, {})}${renderComponent($$result2, "AboutMe", $$AboutMe, {})}${renderComponent($$result2, "ContactsCard", $$ContactsCard, {})}${renderComponent($$result2, "TimeZone", $$TimeZoneCard, {})}${renderComponent($$result2, "Card", $$Index$1, { "colSpan": "md:col-span-1", "rowSpan": "md:row-span-1", "title": "Blog", "body": "More content from web development, coding tutorials, news, bussines is under development!" })}${renderComponent($$result2, "Now", $$Now, {})}${renderComponent($$result2, "Card", $$Index$1, { "colSpan": "md:col-span-1", "rowSpan": "md:row-span-1" }, { "default": ($$result3) => renderTemplate`<p class="text-xs">
